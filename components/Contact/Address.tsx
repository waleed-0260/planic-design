  ...
  return (
    <>
      <div className="flex md:flex-row flex-col md:items-center items-start justify-between w-[90%] my-[50px]">
        <div className="flex justify-start md:flex-row flex-col md:mt-0 mt-5 md:space-x-3 md:space-y-0 space-y-3 space-x-0 md:w-[60%]">
      ...
      <div className="w-[90%] flex items-center justify-between md:flex-row flex-col gap-4">
        <div className="flex flex-col gap-3 w-full">
          <h1 className="text-2xl font-bold"> London, UK</h1>
          <iframe
        ...
        <div className="flex flex-col gap-3 w-full">
        <h1 className="text-2xl font-bold"> Islamabad, Pakistan</h1>
          <iframe
