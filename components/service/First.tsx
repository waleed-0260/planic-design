  ...
  return (
    <div className='flex md:flex-row flex-col items-center justify-around w-[90%] my-[100px]'>
        <div className='flex flex-col space-y-6 md:w-[50%]' data-aos="fade-left">
            ...
            <Link href={"/contact"} className='w-[250px] h-10 flex items-center justify-center gap-4 bg-transparent border-[1px] hover:bg-[#FF4814] border-[#FF4814] text-[#FF4814] hover:text-white rounded-full transition duration-300 text-sm'> Contact Us<IoIosArrowRoundDown/></Link>
