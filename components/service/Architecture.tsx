...
const Architecture = () => {
  return (
      ...
      <div className="flex flex-col md:flex-row justify-between items-start w-full mx-auto py-12 gap-8">
        ...
        >
          ...
          <p className="text-gray-600 text-base md:text-lg">
            Our architecture services include detailed layout plans, space
            optimization, and technical drawings. From concept to construction.
            We handle every stage with precision.
          </p>
          <div>
    ...
    className="object-cover"
      ...
      <div
        className="flex flex-col md:flex-row-reverse justify-between items-start w-full mx-auto py-12 gap-8"
        id="interior"
      >
        {/* Left Content */}
        <div className="flex flex-1 flex-col justify-between md:space-y-0 space-y-4 md:h-[300px]">
          ...
          <p className="text-gray-600 text-base md:text-lg">
            We design interiors that reflect your personality and support your
            lifestyle. Whether you're furnishing a home or styling a cafe, we
            ensure every detail speaks to your vision.{" "}
          </p>
          <div>
            <Link className="button inline-block" href="/portfolio">
              View Portfolio
    ...
    className="object-cover"
      ...
      <div
        className="flex flex-col md:flex-row justify-between items-start w-full mx-auto py-12 gap-8"
        id="visulization"
      >
        {/* Left Content */}
        <div className="flex flex-1 flex-col justify-between md:space-y-0 space-y-4 md:h-[300px]">
          ...
          <p className="text-gray-600 text-base md:text-lg">
            See your space before it’s built. Our 3D visualizations help you
            make design decisions confidently — from furniture layouts to
            lighting mood.{" "}
          </p>
          <div>
            <Link className="button inline-block" href="/portfolio">
    ...
    className="object-cover"
      ...
      >
        ...
        <div className="flex flex-col justify-between md:space-y-0 space-y-4 md:h-[300px] flex-1">
          ...
          <p className="text-gray-600 text-base md:text-lg">
            We handle everything from site assessment to final execution.
            Whether you’re upgrading a space or starting fresh, we bring your
            vision to life with quality and speed.{" "}
          </p>
          <div>
            <Link className="button inline-block" href="/portfolio">
              View Portfolio
