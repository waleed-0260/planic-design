...
const Architecture = () => {
  return (
    ...
    <div className="flex flex-col md:flex-row justify-between items-center w-full mx-auto py-12 gap-8">
      {/* Left Content */}
...
drawings. From concept to construction. We handle every stage with precision.         </p>
        <Link className="button" href="/portfolio">View Portfolio</Link>
      </div>
      ...
      <div className="flex-1 flex justify-center">
        ...
        <div className="flex flex-col md:flex-row-reverse justify-between items-center w-full mx-auto py-12 gap-8">
      {/* Left Content */}
      <div className="flex-1 space-y-5">
        <h2 className="text-3xl md:text-4xl leading-tight">
