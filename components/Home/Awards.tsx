...
const Awards = () => {
  ...
  {awards.map((item, index) => {
    return (
      <div
        className="w-full py-4 flex md:flex-row flex-col justify-between md:items-center items-start md:hover:bg-red-700 transition-all text-white p-4 rounded-full md:gap-0 gap-4"
        key={index}
      >
        {/* Date */}
