  ...
  return (
    <div className='w-[90%] flex flex-col items-start my-[50px]' data-aos="fade-up">
        ...
        <div className='flex md:flex-row flex-col justify-between md:items-center w-full my-[50px]'>
            ...
            <Link href={"/portfolio"} className='w-[200px] h-[50px] bg-transparent border-[1px] hover:bg-[#FF4814] border-[#FF4814] text-[#FF4814] rounded-full  transition-all hover:shadow-lg hover:text-white flex flex-row items-center justify-center text-sm gap-3 sm:mt-0 mt-5'>Featured Projects <GoArrowUpRight/></Link>
            </div>
